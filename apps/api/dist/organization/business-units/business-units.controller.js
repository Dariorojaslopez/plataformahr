...
let BusinessUnitsController = class BusinessUnitsController {
    ...
    update(tenant, user, id, dto) {
        return this.businessUnitsService.update(tenant.companyId, user.userId, id, dto);
    }
};
...
], BusinessUnitsController.prototype, "list", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, business_unit_dto_1.CreateBusinessUnitDto]),
    __metadata("design:returntype", void 0)
], BusinessUnitsController.prototype, "create", null);
__decorate([
    (0, common_1.Patch)(':id'),
    (0, require_permissions_decorator_1.RequirePermissions)('organization.manage'),
    __param(0, (0, current_tenant_decorator_1.CurrentTenant)()),
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, String, business_unit_dto_1.UpdateBusinessUnitDto]),
    __metadata("design:returntype", void 0)
], BusinessUnitsController.prototype, "update", null);
exports.BusinessUnitsController = BusinessUnitsController = __decorate([
    (0, common_1.Controller)('organization/business-units'),
