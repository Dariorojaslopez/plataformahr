...
export function isNineBoxHexColor(value: string): boolean {
  return HEX_COLOR.test(value);
}

/** Maps a 0–100 score into low / mid / high bands. */
...
/**
 * X (col) = desempeño (overallScore).
 * Y (row) = potencial (competencyScore, fallback overall).
 */
