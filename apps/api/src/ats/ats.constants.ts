export const ATS_AUDIT = {
  ...
  VACANCY_CONFIDENTIAL_UPDATED: 'VACANCY_CONFIDENTIAL_UPDATED',
  VACANCY_PUBLISHED: 'VACANCY_PUBLISHED',
  VACANCY_UNPUBLISHED: 'VACANCY_UNPUBLISHED',
  CANDIDATE_CREATED: 'CANDIDATE_CREATED',
  CANDIDATE_UPDATED: 'CANDIDATE_UPDATED',
  CANDIDATE_DELETED: 'CANDIDATE_DELETED',
  CANDIDATE_CV_UPLOADED: 'CANDIDATE_CV_UPLOADED',
  ...
  OFFER_SIGNED_LETTER_UPLOADED: 'OFFER_SIGNED_LETTER_UPLOADED',
  OFFER_SIGNED_LETTER_REMOVED: 'OFFER_SIGNED_LETTER_REMOVED',
  OFFER_LETTER_APPROVAL_STARTED: 'OFFER_LETTER_APPROVAL_STARTED',
  OFFER_LETTER_APPROVAL_APPROVED: 'OFFER_LETTER_APPROVAL_APPROVED',
  OFFER_LETTER_APPROVAL_REJECTED: 'OFFER_LETTER_APPROVAL_REJECTED',
  OFFER_LETTER_SENT: 'OFFER_LETTER_SENT',
  OFFER_LETTER_CANDIDATE_SIGNED: 'OFFER_LETTER_CANDIDATE_SIGNED',
  CONTRACT_APPROVAL_STARTED: 'CONTRACT_APPROVAL_STARTED',
  CONTRACT_APPROVAL_APPROVED: 'CONTRACT_APPROVAL_APPROVED',
  CONTRACT_APPROVAL_REJECTED: 'CONTRACT_APPROVAL_REJECTED',
  CONTRACT_UPLOADED: 'CONTRACT_UPLOADED',
  CONTRACT_SENT: 'CONTRACT_SENT',
  CONTRACT_CANDIDATE_SIGNED: 'CONTRACT_CANDIDATE_SIGNED',
  HIRING_COMPLETED: 'HIRING_COMPLETED',
  FINALIST_DISCARDED_ON_HIRE: 'FINALIST_DISCARDED_ON_HIRE',
  FINALIST_THANK_YOU_QUEUED: 'FINALIST_THANK_YOU_QUEUED',
  FINALIST_THANK_YOU_SENT: 'FINALIST_THANK_YOU_SENT',
  HIRE_PDI_SYNCED: 'HIRE_PDI_SYNCED',
  HIRE_PDI_SKIPPED: 'HIRE_PDI_SKIPPED',
  CONTRACT_TEMPLATE_APPROVERS_UPDATED: 'CONTRACT_TEMPLATE_APPROVERS_UPDATED',
  OFFER_LETTER_TEMPLATE_APPROVERS_UPDATED:
    'OFFER_LETTER_TEMPLATE_APPROVERS_UPDATED',
  ATS_DOCUMENT_TEMPLATES_UPDATED: 'ATS_DOCUMENT_TEMPLATES_UPDATED',
  EVALUATOR_DECISION_APPROVED: 'EVALUATOR_DECISION_APPROVED',
  EVALUATOR_DECISION_REJECTED: 'EVALUATOR_DECISION_REJECTED',
  RECRUITER_EVALUATION_READY: 'RECRUITER_EVALUATION_READY',
  PREHIRE_UPDATED: 'PREHIRE_UPDATED',
  PREHIRE_DOCUMENT_UPLOADED: 'PREHIRE_DOCUMENT_UPLOADED',
} as const;
...
/** Default minimum days before expectedHiringDate when company has no override. */
