...
export default function SelectCompanyPage() {
  ...
  const { status, user, companies, selectCompany, logout } = useSession();
  ...
  }, [status, user, companies.length, router]);
    ...
    return (
      <div className="mx-auto flex min-h-screen w-full max-w-2xl items-center p-6">
        <EmptyState
          ...
          description="Tu usuario no tiene memberships activas. Contacta a un administrador."
          action={
            <Button
              type="button"
              variant="outline"
